...
class PublishStatus(threading.Thread):
    def __init__(self, server, lock):
        ...
        self.server = server
        self.lock = lock
        self._status_publisher = rospy.Publisher("/introspection/status",SmachStateMachineStatus,latch=True,queue_size=1)
    ...
    def _create_message(self):
        ...
        msg = SmachStateMachineStatus(Header(stamp=rospy.Time.now()),1,
                actives_states,
